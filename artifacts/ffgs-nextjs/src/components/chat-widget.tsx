...
const LOGO  = img("/chat-logo-ffgs.webp");
    ...
    if (match[1] !== undefined) {
      ...
      nodes.push(
        <a key={key++} href={href}
          ...
          className="underline font-medium text-primary [&]:text-primary hover:opacity-80">
          {match[1]}
        </a>
      );
    } else {
...
const WELCOME = "Hi! I can answer questions about the Fly Fishing Guide School — the curriculum, tuition, what to expect, who it's for, and how to enroll. What would you like to know?";
        ...
        <div className="w-[340px] sm:w-[380px] bg-background border border-border shadow-2xl flex flex-col overflow-hidden"
          ...
          <div className="bg-primary text-primary-foreground px-4 py-3 flex items-center shrink-0">
            ...
            <div className="flex-1 flex flex-col items-center">
              <img src={LOGO} alt="Fly Fishing Guide School" className="h-10 w-auto" />
              <p className="text-xs text-primary-foreground/70 mt-0.5">Ask about enrollment, curriculum & more</p>
            </div>
          ...
          <div className="shrink-0 border-t border-border px-3 py-2 flex items-center gap-2">
            {questionsUsed >= MAX_QUESTIONS ? (
              <p className="flex-1 text-xs text-muted-foreground text-center py-1">
                ...
                <a href="/guide-school" className="text-primary underline">learn more here</a>.
              </p>
            ) : (
              <>
                <input
