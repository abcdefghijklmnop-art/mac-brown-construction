...
export const metadata: Metadata = {
  title: { absolute: "Privacy Policy — Mac Brown Fly Fish" },
  description: "Privacy Policy for Mac Brown Fly Fish. Learn how we collect, use, and protect your personal information.",
  alternates: { canonical: "https://macbrownflyfish.com/privacy-policy/" },
  robots: { index: false },
};
    ...
    <div className="min-h-screen bg-background">
      <div className="max-w-3xl mx-auto px-6 py-20">
        ...
        <p className="text-base text-foreground/80 leading-relaxed mb-10">
          This Privacy Policy describes how Mac Brown Fly Fish ("we," "us," or "our"), operating at macbrownflyfish.com,
          collects, uses, and protects information you provide when visiting our website or using our services. We are
          committed to safeguarding your privacy and handling your data with care and transparency.
        </p>
        ...
        <Section title="9. Your Rights and Choices">
          ...
          <p>
            ...
            <a href="mailto:info@macbrownflyfish.com" className="text-primary underline underline-offset-2 hover:opacity-80">
              info@macbrownflyfish.com
            </a>.
          </p>
        </Section>
        ...
        <Section title="12. Contact Us">
          ...
          <ul>
            <li>Website: <a href="https://macbrownflyfish.com" className="text-primary underline underline-offset-2 hover:opacity-80">macbrownflyfish.com</a></li>
            <li>Email: <a href="mailto:macbrownflyfish@gmail.com" className="text-primary underline underline-offset-2 hover:opacity-80">macbrownflyfish@gmail.com</a></li>
          </ul>
        </Section>

        <p className="text-sm text-muted-foreground mt-12 pt-8 border-t border-border">
          © 2026 Mac Brown Fly Fish. All rights reserved.
        </p>
      </div>
    </div>
  );
